...
_TS_DECLARE = f"{_TS}:963"  # registry.declare in _register_v2_terminal_resources
_TS_MARK = f"{_TS}:1011"  # registry.register_created in _mark_v2_resource_created
_TS_MONITOR = f"{_TS}:979"  # registry.monitor in _register_v2_terminal_resources
