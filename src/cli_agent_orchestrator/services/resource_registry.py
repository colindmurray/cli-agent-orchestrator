...
_BR_JOURNAL_MARK = f"{_BR}:3855"  # registry.register_created in _mark_bridge_journal_created
_BR_DELETE = f"{_BR}:4008"  # registry.delete in _deregister_bridge_resources
