...
_BR_DECLARE = f"{_BR}:3704"  # registry.declare in _declare_bridge_resources
_BR_MARK = f"{_BR}:3748"  # registry.register_created in _mark_bridge_resource_created
_BR_JOURNAL_MARK = f"{_BR}:3772"  # registry.register_created in _mark_bridge_journal_created
_BR_DELETE = f"{_BR}:3925"  # registry.delete in _deregister_bridge_resources
